...
for var in ${filterArr[@]}; do
  ...
  then
    ...
    awk 'BEGIN{r0="initrowhere"} {var=$2"-"$5"-"$6; if(r0!=var){print $0}else{print $0 > "removed_duplicated_rows_GRCh37"}; r0=var}' gb_unique_rows > gb_unique_rows2
  ...
  then
    ...
    awk 'BEGIN{r0="initrowhere"} {var=$2; if(r0!=var){print $0}else{print $0 > "removed_duplicated_rows_GRCh37_hard"}; r0=var}' gb_unique_rows > gb_unique_rows2
  ...
  then
    ...
    awk 'BEGIN{r0="initrowhere"} {var=$1; if(r0!=var){print $0}else{print $0 > "removed_duplicated_rows_GRCh38_hard"}; r0=var}' gb_unique_rows > gb_unique_rows2
  ...
  then
    ...
    awk -vFS="\t" -vOFS="\t" '{if($6 ~ /,/){print > "removed_multiallelic_rows"}else{print $0} }' gb_unique_rows > gb_unique_rows2
