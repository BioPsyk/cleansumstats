...
class Metadata extends BaseMetadata {
  ...
  // groovy class should be generated by running the pipeline with the `--generateMetaClass`
  ...
  String cleansumstats_metafile_date = null
  ...
  int stats_TotalN = 0.0
  int stats_CaseN = 0.0
  int stats_ControlN = 0.0
  String stats_GCMethod = null
  float stats_GCValue = 0
