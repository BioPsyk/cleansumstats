...
function general_usage(){
 ...
 echo ""
 echo "Run tests (requires container):"
 echo " ./cleansumstats.sh test      # Run all tests"
 echo " ./cleansumstats.sh utest     # Run unit tests only"
 echo " ./cleansumstats.sh etest     # Run end-to-end tests only"
 echo ""
 echo "options:"
