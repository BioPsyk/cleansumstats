...
#Manually added real eurAF from 1000G. The idea is that the EAF_1KGP column should contain the same as EAF after cleaning.
...
rs12754538	chr1	8408079	T	C	0.308	-6e-04	0.015	0.01488802	0.2167
